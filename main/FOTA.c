...
char *tar_file = "sdcard0/test_tar.tar";
...
void http_result_cb(nwy_ftp_result_t *param)
{
    ...
    else if (NWY_HTTPS_SSL_CONNECTED == param->event)
    {
        ...
        nwy_sdk_file_unlink("/sdcard0/test_app.pack");
        nwy_sdk_file_unlink("/sdcard0/test_app.bin");
        nwy_sdk_file_unlink("/sdcard0/tork_firmware_app.bin");
        nwy_sdk_file_unlink("/sdcard0/test_tar.tar");
        nwy_ext_echo("\r\n...............SSL connected..............\r\n");
...
//     nwy_sleep(100);
//     ftp_param.channel = 1;
//     // strcpy((char *)ftp_param.host, "24.365.653.5");
//     strcpy((char *)ftp_param.host, "115.29.178.98");
//     ftp_param.port = 2121;
//     ftp_param.mode = 0;
//     strcpy((char *)ftp_param.username, "neoway");
//     strcpy((char *)ftp_param.passwd, "neoway");
//     ftp_param.timeout = 180;
//     memset(&g_fileftp, 0x00, sizeof(g_fileftp));
//     result = nwy_ftp_login(&ftp_param, ftp_result_cb);
...
//             if (param->data_len != 0)
//             {
//                 ret = test_ftp_write_file(&g_fileftp, param->data, param->data_len);
//                 if (0 != ret)
//                 {
//                     nwy_ext_echo("\r\nwrite failed");
//                 }
...
void ia_fota_test()
{
    ...
    char *fota_file = "/sdcard0/test_app.pack";
...
{
    /*************UNTAR************/
    uint8_t* n58_filename = "/sdcard0/test_app.pack";
    uint8_t* s32_filename = "/sdcard0/test_app.bin";
    uint8_t* tork_filename = "/sdcard0/tork_firmware_app.bin";
